...
public class Tester {
	...
	public static void main(String[] args) throws Exception {
	  ...
	  */
		...
		int[] first  =  {9,6,7,3};  // Base 10 coefficient representation for the integer number 9375
		int[] second =  {2,8,0};        // Base 10 coefficient representation for the integer number 81
